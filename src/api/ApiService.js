...
export const getFarmExpense = (id) => axios.get(`http://localhost:8080/users/${id}/farm/percentage`)

export const getFarm = (id) => axios.get(`http://localhost:8080/users/${id}/farm`)
